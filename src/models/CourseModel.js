const coursesData = [
    ...
    content: [
      ...
      },
      {
        ...
        data: [
          ...
          {
            title:
              'Generate React Native Project & Run App On Simulators/Devices',
            time: '12:53',
          },
          {
      ...
      },
      {
        ...
        data: [
          ...
          {
            title:
              'Using ScrollView/Image/FlatList/SectionList/Alert/Share in React Native',
            time: '2:05:20',
          },
        ],
      },
  ...
  },
  {
    id: 17,
    title:
      'Angular Denver 2019: Simplifying Front end State Management with Observable Store',
    author: 'Angular Denver',
    level: 'Intermediate',
    released: 'Sep 11, 2019',
    duration: ' 24m 28s',
    ...
    content: [
      {
        ...
        data: [
          {
            title:
              'Angular Denver 2019: Supercharge Your Angular Test with Jest',
            time: '22m 48s',
          },
        ],
      },
  ...
  },
  {
    id: 20,
    title:
      'Angular Denver 2019: Bridging Parallel Universes: Upgrading Huge Apps with Angular Elements',
    author: 'Angular Denver',
    level: 'Intermediate',
    released: 'Sep 11, 2019',
    duration: ' 20m 36s',
  ...
  },
  {
    id: 21,
    title:
      'Angular Denver 2019: Machine Learning in Angular with TensorFlow.js',
    author: 'Angular Denver',
    level: 'Intermediate',
    released: 'Sep 11, 2019',
    duration: ' 22m 4s',
  ...
  },
  {
    id: 22,
    title:
      'Angular Denver 2019: Rendering Angular Applications in Terminal, Angular Platform',
    author: 'Angular Denver',
    level: 'Intermediate',
    released: 'Sep 11, 2019',
    duration: ' 20m 24s',
    content: [
      {
        ...
        data: [
          {
            title:
              'Rendering Angular Applications in Terminal, Angular Platform',
            time: '20m 24s',
          },
        ],
      },
  ...
  },
  {
    id: 43,
    title:
      'Reversing the Gophe Spambot: Confronting COM Code and Surmouting STL Snags',
    author: 'BSides Huntsville',
    level: 'Intermediate',
    released: 'Feb 29, 2020',
    duration: '40m 9s',
  ...
  },
  {
    ...
    content: [
      {
        detail:
          '5 Ideas For Writing Better Cloud Native Microservice: CodeMash',
        time: '50m 11s',
        data: [
          {
            title:
  ...
  },
  {
    ...
    content: [
      {
        detail:
          'The State of .NET and Looking Ahead to 2020: DEVintersection 2019',
        time: '59m 27s',
        data: [
          {
            title:
  ...
  },
  {
    id: 56,
    title:
      'Building Modern .NET Desktop Apps with .NET core and Windows 10: DEVitersection 2019',
    author: 'DEVintersection',
    level: 'Intermediate',
    released: 'Dec 10, 2019',
    duration: '52m 16s',
  ...
  },
  {
    id: 57,
    title:
      'Building the Best Web App with lastest Updates to ASP.NET Core for 2020: DEVintersection 2019',
    author: 'DEVintersection',
    level: 'Intermediate',
    released: 'Dec 10, 2019',
    duration: '48m 56s',
    ...
    content: [
      {
        ...
        data: [
          {
            title:
              'What You Need to Know About .NET Core: DEVintersection 2019',
            time: '1h 2m',
          },
        ],
      },
    ...
    content: [
      ...
      },
      {
        ...
        data: [
          {
            title:
              'Setting up a Java Maven Development Enviroment with Eclipse',
            time: '41m 24s',
          },
        ],
      },
  ...
  },
  {
    ...
    content: [
      ...
      {
        detail:
          'Generating OpenAPI Specifications for Advenced input and Output Scenarios',
        time: '30m 5s',
        data: [
          {
            title:
    ...
    content: [
      {
        ...
        data: [
          {
            title:
              'Configuring Security Services and Polices in Microsoft Azure',
            time: '1h 52m',
          },
        ],
      },
  ...
  },
  {
    id: 105,
    title:
      'Monitor Azure Resources and Web Applications with System Center Operations Manager (SCOM)',
    author: 'Greg Shield',
    level: 'Intermediate',
    released: 'Dec 10, 2019',
    duration: '48m 56s',
        ...
        content: [
          ...
          },
          {
            ...
            data: [
              {
                title:
                  'Improving Reliablitity with Advanced Content Negotiation',
                time: '42m 27s',
              },
            ],
          },
        ...
        content: [
          ...
          },
          {
            ...
            data: [
              {
                title:
                  'Building Xcode Project: Configuring Schemes and Targets',
                time: '22m 38s',
              },
            ],
          },
        ...
        content: [
          {
            ...
            data: [
              {
                title:
                  'Introduction System Center 2016 - Operations Manager SCOM',
                time: '1h 5m',
              },
            ],
          },
...
const authors = [
  ...
  },
  {
    ...
    title: 'Elearning.io Author',
    description:
      'Huy Nguyen is a sofware developer, consultant, conference speaker, and Elearning.io Author. Him Courses include: Angular, OOP Fundamentals in C#. For him work in support of sofware developers, she has been recognized with the Microsoft Most valuable Professional (MVP) award, and is a Google Developer Expert (GDE).',
    course: [
      {
        id: 115,
        title: 'Angular Denver 2019: Keynote talk',
  ...
  },
  {
    ...
    title: 'Elearning.io Author',
    description:
      'Hai Pham is a sofware developer, consultant, conference speaker, and Elearning.io Author. Him Courses include: Angular, OOP Fundamentals in C#. For him work in support of sofware developers, she has been recognized with the Microsoft Most valuable Professional (MVP) award, and is a Google Developer Expert (GDE).',
    course: [
      {
        id: 124,
        title: 'Angular Denver 2019: Keynote talk',
  ...
  },
  {
    ...
    title: 'Elearning.io Author',
    description:
      'Bryan is a sofware developer, consultant, conference speaker, and Elearning.io Author. Him Courses include: Angular, OOP Fundamentals in C#. For him work in support of sofware developers, she has been recognized with the Microsoft Most valuable Professional (MVP) award, and is a Google Developer Expert (GDE).',
    course: [
      {
        id: 133,
        title: 'Angular Denver 2019: Keynote talk',
  ...
  },
  {
    ...
    title: 'Elearning.io Author',
    description:
      'Shawn is a sofware developer, consultant, conference speaker, and Elearning.io Author. Him Courses include: Angular, OOP Fundamentals in C#. For him work in support of sofware developers, she has been recognized with the Microsoft Most valuable Professional (MVP) award, and is a Google Developer Expert (GDE).',
    course: [
      {
        id: 142,
        title: 'Angular Denver 2019: Keynote talk',
  ...
  },
  {
    ...
    title: 'Elearning.io Author',
    description:
      'Barry is a sofware developer, consultant, conference speaker, and Elearning.io Author. Him Courses include: Angular, OOP Fundamentals in C#. For him work in support of sofware developers, she has been recognized with the Microsoft Most valuable Professional (MVP) award, and is a Google Developer Expert (GDE).',
    course: [
      {
        id: 151,
        title: 'Angular Denver 2019: Keynote talk',
  ...
  },
  {
    ...
    title: 'Elearning.io Author',
    description:
      'Josh is a sofware developer, consultant, conference speaker, and Elearning.io Author. Him Courses include: Angular, OOP Fundamentals in C#. For him work in support of sofware developers, she has been recognized with the Microsoft Most valuable Professional (MVP) award, and is a Google Developer Expert (GDE).',
    course: [
      {
        id: 160,
        title: 'Angular Denver 2019: Keynote talk',
  ...
  },
  {
    ...
    title: 'Elearning.io Author',
    description:
      'Scott Allen has worked on every thing from 8-bit embedded devices to large scale web sites. During his 15+ years in commercial sofware development. Since 2001, Scott has focused on server-side and web technologies, like ASP.NET, ASP.NET AJAX, Windows Workflow, Silverlight, and LNQ.',
    course: [
      {
        id: 169,
        title:
